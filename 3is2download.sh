...
#wget -nc -i 5000004802991.txt
# https://n5eil02u.ecs.nsidc.org/esir/5000004802991.txt
# data/atl03_data/canada_2010_32608
#wget --load-cookies ~/.urs_cookies --save-cookies ~/.urs_cookies --keep-session-cookies -nc -i https://n5eil02u.ecs.nsidc.org/esir/5000004802991.txt  -P ../canada_2010_32614
# 5000004803002
