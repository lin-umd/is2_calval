...
# find weher is La_Selva_05102019_001_827300_1155500
glob.glob('/gpfs/data1/vclgp/data/gedi/imported/*/*/LAZ_ground/La_Selva_05102019_001_827300_1155500.laz')


# In[30]:


laz_fs = glob.glob('/gpfs/data1/vclgp/data/gedi/imported/seasia/jpl_borneo_119/LAZ_ground/*.laz')
las_out = '/gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/las/centralamerica/costarica_laselva2019'
las_fs = glob.glob('/gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/las/centralamerica/costarica_laselva2019/*.las')
# for f in las_fs:
#     print(f)
#     #os.system(f'las2las -i {f} -odir {las_out} -olas')
#     os.system(f'lasinfo -i {f} ')
...
#laz_path = '/gpfs/data1/vclgp/data/gedi/imported/usa/usda_or/LAZ_ground/or_10_101.laz'
    ...
    ###########################################################################
                    ...
                    out_coor = '../wave/coordinates_'+ basename[:-4] + '.txt'####
                    out_las = '../wave/lasfiles_'+ basename[:-4] + '.txt'
                    ...
                    #new_path = '/gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/las/' + split_columns.str[-4] + '/' + split_columns.str[-3] + '/' + split_columns.str[-1]
                    bs_las_path.to_csv(out_las, sep=' ', header = False,  index = False) 
                    #######################################################################################
...
for index, row in gdf_als[8:].iterrows(): 
