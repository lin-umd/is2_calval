...
#ih3_extract_shots -o /gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/result/is2_20m_cal_val_12262023 -r /gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/data/all_sites_20231218.parquet --atl08 land_segments/canopy/h_canopy_20m orbit_info/sc_orient root_file root_beam  land_segments/delta_time  land_segments/terrain/h_te_best_fit land_segments/canopy/n_ca_photons land_segments/night_flag land_segments/solar_elevation land_segments/canopy/h_canopy_uncertainty land_segments/terrain/h_te_median land_segments/terrain/h_te_uncertainty -q_20m '`land_segments/canopy/h_canopy_20m` < 200'  -n 15  --merge

echo "get is2 calval data"
echo "April 17th 2019 and March 16th 2023"
ih3_extract_shots -o /gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/data/is2_20m_cal_val_disturbed_20250721 -r /gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/data/calval_sites_20250721.parquet --atl08 land_segments/canopy/h_canopy_20m orbit_info/sc_orient root_file root_beam  land_segments/delta_time  land_segments/terrain/h_te_best_fit land_segments/canopy/n_ca_photons land_segments/night_flag land_segments/solar_elevation land_segments/canopy/h_canopy_uncertainty land_segments/terrain/h_te_uncertainty land_segments/snr -a "{'glad_forest_loss':['lossyear']}"  -q_20m '`land_segments/canopy/h_canopy_20m` < 200'  -n 15  --merge -t0 2019-04-17 -t1 2023-03-16
