...
if __name__ == "__main__":
    parse = argparse.ArgumentParser(description="Run gdal_tranlaste -outsize to reduce input size by n%")
    ...
    client.close()
    sys.exit("## -- DONE")
    # for index, row in gdf_1_polygon[:2].iterrows():
    #     # is2_list(f_in_polygon, f_out)
    #       is2_list(row['geometry'], args.output_folder, index)
# example use
# python 3is2query.py --input_file ../data/all_sites_20231130.parquet --output_folder ../result/atl03_list/