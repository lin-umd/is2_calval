...
#laz_path = '/gpfs/data1/vclgp/data/gedi/imported/usa/usda_or/LAZ_ground/or_10_101.laz'
                    is2_in_als_utm = gpd.read_parquet('/gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/result/is2_in_als_utm.parquet')
...
if __name__ == '__main__':
            ...
            for index, row in gdf_als.iterrows(): 
                    ...
                    is2_in_als_utm.to_parquet('/gpfs/data1/vclgp/xiongl/ProjectIS2CalVal/result/is2_in_als_utm.parquet')
                    ########################################################### 
                    ...
                    if (len(laz_files) < 10000): continue
