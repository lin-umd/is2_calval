...
if __name__ == '__main__':
    ...
    cmds = [sim_is2_laz(laz_f,output=output_folder, lamda = args.lamda, ratiopvpg=args.ratiopvpg, overwrite_wave=False, overwrite_photon=False) for laz_f in all_lazs]  ## if update merge to new shots  
...
# example use:
# python 1is2simulation.py --name csir_welverdient
# python 1is2simulation.py --name litchfield
# python 1is2simulation.py --name plumasnf_20180707
# python 1is2simulation.py --lamda 0.5 --output ../result/lamda0point5 --test --ratiopvpg 0.75