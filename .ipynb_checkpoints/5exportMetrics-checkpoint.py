...
#VALID_SITES =['neon_yell2018', 'neon_yell2019', 'neon_yell2020']
...
if __name__ == '__main__':
            ...
            parse.add_argument("--use", dest="use", help="Use existing site cal/val data", action="store_true", required=False)
            parse.add_argument("--name", dest="name", help="Specific project name", type=str, required=False)
            ...
            columns_to_concat = ['land_segments/latitude_20m', 'land_segments/longitude_20m', 'land_segments/delta_time', 'laz']# add laz for overlapped lazs.
            for index, row in gdf_als.iterrows(): ## all sites 
                ...
                if args.use and os.path.exists(f_out):
                    ...
                    try: 
                        ...
                        print(region, name)
                        continue
                    final = pd.merge(gdf_is2, df_sim_als, on=['land_segments/latitude_20m', 'land_segments/longitude_20m', 'land_segments/delta_time'])
                    # strong flag
            ...
            sys.exit("## DONE")
# example use
# python 5exportMetrics.py --name neon_wref2021
# python 5exportMetrics.py --name neon_abby2019
# python 5exportMetrics.py --use
